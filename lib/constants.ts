export const PRAYER_CATEGORIES = [
  { id: "DAILY",         label: "Daily Prayer",       icon: "🌅", bg: "bg-amber-50",   text: "text-amber-700",   border: "border-amber-200" },
  ...
  { id: "THANKSGIVING",  label: "Thanksgiving",       icon: "🌟", bg: "bg-yellow-50",  text: "text-yellow-700",  border: "border-yellow-200" },
